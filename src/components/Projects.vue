<template>
    <section id="techstacks">
        <div class="w-12/12 m-auto p-5 sm:w-10/12 md:w-8/12">
            ...
            <div class="sm:flex sm:gap-4 mt-3 items-stretch">
                ...
                <div class="sm:flex-1 p-3 bg-dark-secondary rounded-lg flex flex-col mt-3 sm:mt-0">
                    <h4 class="text-light-primary tracking-wide font-bold mb-2">Radish.</h4>
                    <p class="text-light-secondary mb-2">
            ...
            <div class="sm:flex sm:gap-4 mt-4 items-stretch">
                <div class="sm:flex-1 p-3 bg-dark-secondary rounded-lg flex flex-col">
...
export default {
    data() {
        return {
            links: {
                mangarider: 'https://github.com/Aldrin-DP/mangarider',
